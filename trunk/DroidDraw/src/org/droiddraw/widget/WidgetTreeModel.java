...
public class WidgetTreeModel implements TreeModel {
	...
	public void removeWidget(Widget w) {
		...
		fireNodeRemovedEvent(new TreeModelEvent(this, path, new int[] { index }, new Object[] { w }));
	}
	...
	public void addWidget(Widget w) {
		...
		Object[] path = findPath(parent);
		int index = parent.getWidgets().indexOf(w);
		fireNodeInsertedEvent(new TreeModelEvent(this, path, new int[] { index }, new Object[] {w}));
	}
